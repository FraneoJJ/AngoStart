...
SOURCE = ROOT / "RELATORIO_TFC_ANGOSTART.md"
OUTPUT = ROOT / "RELATORIO_FINAL_ANGOSTART.pdf"


def register_font():
    # Fonte com suporte a acentos para português.
